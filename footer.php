        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <ul class="menu-list">
                    ...
                    <li><a href="all_products.php">List of all Books</a></li>
                </ul>
            </div>
            <div class="col-md-3">
                <h3>Contact Us</h3>
            ...
            <div class="col-md-12">
                <span><?php echo $footer[0]['footer_text'] ?> | Created by <a href="" target="_blank">United International University RMA</a></span>
            </div>
        </div>
    </div>
</div>
